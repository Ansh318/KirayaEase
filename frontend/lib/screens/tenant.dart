...
import '../widgets/split_payments.dart';
  ...
  Future<void> fetchUserName() async {
    try {
      final response = await http.get(
        Uri.parse(
            "https://kiraya-ease-50d651c2ed49.herokuapp.com/user-profile"),
      );
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Your property will receive ₹1,40,000 on Oct 1st',
                              style: TextStyle(
                  ...
                  const _PaymentRow(title: 'Wed, Oct 1st', amount: '₹70,000'),
                  const _PaymentRow(title: 'Wed, Oct 17th', amount: '₹70,000'),
                  const Padding(
                    padding: EdgeInsets.fromLTRB(16, 16, 16, 8),
                    child: Text(
                      'Payment methods',
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            showScheduleRentSplitSheet(
                              context: context,
                              monthlyRent:
                                  140000, // <-- replace with your rent variable
                              onConfirm: (_) {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: const [
                        ...
                        SizedBox(height: 50), // extra space before subtitle
                        Text(
